...
variable "target_sa_pam_grants_role_id" {
  description = "Role ID for the project-level custom IAM role granting PAM entitlement management and grant lifecycle actions to the target service account."
  type        = string
